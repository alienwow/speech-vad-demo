...
//int Java_com_baidu_speech_restapi_jniTest_FileCutUtil_setFile(char *filename,char *output_filename_prefix);

//int add_cut_file_activity(struct cut_info *cut, int is_active, int is_last);


//int main(){
//	int a = Java_com_baidu_speech_restapi_jniTest_FileCutUtil_setFile("pcm/16k_1.pcm","16k_1.pcm");
//	return a;
//}
